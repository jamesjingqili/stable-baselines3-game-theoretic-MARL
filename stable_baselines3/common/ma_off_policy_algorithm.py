...
ma_SelfOffPolicyAlgorithm = TypeVar("ma_SelfOffPolicyAlgorithm", bound="ma_OffPolicyAlgorithm")


class ma_OffPolicyAlgorithm(BaseAlgorithm):
    """
    ...
    def learn(
        self: ma_SelfOffPolicyAlgorithm,
        total_timesteps: int,
        callback: MaybeCallback = None,
        log_interval: int = 4,
        tb_log_name: str = "run",
